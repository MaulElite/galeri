<?php
    ...
    if(isset($_POST['username'])){
        ...
        if($query > 0) {
            ...
            echo '<script> alert("Register Berhasil, Siahkan Login")</script>';
        }else{
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-login-image">
                                <img src="img/undraw_posting_photo.svg" alt="10">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="login.php">Have an account? Login</a>
                                    </div>
                                </div>
                            </div>
                        </div>
